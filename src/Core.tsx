...
const ReactEChartsCore = memo(
  forwardRef<ChartRef, EChartsReactProps>((props, ref) => {
    ...
    const addListenChartEvent = useCallback(
      (events: EChartsReactProps['onEvents'] = {}) => {
        function _on(
          ...
          if (query) {
            (echartsInstance?.on as unknown as any)?.(
              eventName,
              query,
              handler,
            );
    ...
    }, [createEChartsInstance, dispose, getEChartsInstance]);
    ...
    }, [addListenChartEvent, addListenResize, initEChartsInstance]);
...
ReactEChartsCore.displayName = 'ReactEChartsCore';
